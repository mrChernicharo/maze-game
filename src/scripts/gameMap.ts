...
const mazeGenerator = new MazeGenerator(dims[0], dims[1]);
const maze = await mazeGenerator.generate();
// console.log(maze);
...
maze.forEach((line) => {
    line.forEach((cell) => {
        ...
        const topX = cell.col * MAP_CELL_SIZE;
        const topY = cell.row * MAP_CELL_SIZE;
